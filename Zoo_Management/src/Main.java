...
public class Main {
        ...
        do {
            switch (animalChoiceMenu(keyboard)) {
                ...
                case 3:
                    ...
                    break;
                /**
                 * case 4 to call the writeObjectsToFile method to save the
                ...
                case 4:
                    ...
                    break;
                /**
                 * case 5 to call the readObjectsFromFile method to
    ...
    /**
     * a method named writeObjectsToFile and pass Tiger, Penguin and Dolphin to be saved onto a file.
     *  Save the state of Tiger to output tiger.txt file
     *  Save the state of Penguin to output penguin.txt file
     *  Save the state of Dolphin to output dolphin.txt file
     */
     ...
     * Print the save state of Tiger from the file tiger.txt
     * Print the save state of Penguin from the file penguin.txt
     * Print the save state of Dolphin from the file dolphin.txt
     */
